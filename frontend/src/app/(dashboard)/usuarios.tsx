...
const styles = StyleSheet.create({
  ...
  helpText: { opacity: 0.65, marginBottom: Spacing.two, lineHeight: 18 },
  statsRow: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: Spacing.one,
  ...
  statLabel: { opacity: 0.6, textTransform: 'uppercase', fontSize: 10, fontWeight: '500' },
  statValue: { fontSize: 19, lineHeight: 24, fontWeight: '600' },
  statValueGreen: { color: '#22C55E' },
  filtersBlock: {
    marginBottom: Spacing.two,
    gap: 2,
  },
  filterLabel: { fontWeight: '600', opacity: 0.7, marginLeft: Spacing.one, fontSize: 12 },
  filterLabelSpaced: { marginTop: Spacing.one },
  list: {
    gap: Spacing.two,
  ...
  rolesRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 5, marginTop: 3 },
  roleBadge: {
    paddingHorizontal: 8,
    paddingVertical: 3,
    borderRadius: 12,
